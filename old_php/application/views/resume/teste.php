...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo css_url('material.css')?>">
  ...
  <body>
      ...
      <main class="demo-main mdl-layout__content">
        <div class="demo-container mdl-grid">
          ...
          <div class="demo-content mdl-color--white mdl-shadow--4dp content mdl-color-text--grey-800 mdl-cell mdl-cell--8-col">
            <h3 class="title">Diovane Barbieri Gabriel</h3>
            <h4 class="title">Desenvolvedor</h4>
            <a href="mailto:diovane.gabriel@gmail.com">diovane.gabriel@gmail.com</a>
              <p>
    ...
    <a href="#" onclick="window.print(); return true;" target="_blank" id="view-source" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-color--accent mdl-color-text--accent-contrast">Imprimir</a>
